  ...
  return (
    <>
      <div className="flex min-h-screen flex-col gap-1 bg-gray-100">
        ...
        {/* ---------------------------------------------------- Main Body ----------------------------------------- */}
        <div className="flex flex-col gap-6 border px-6 py-4">
          {/*---------------------------------------------- First Section -------------------------------------------*/}
          ...
          <Box className="rounded-lg border bg-white px-4 py-3 shadow-md">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex justify-end gap-3">
                <Button
                  variant="contained"
                  className="!rounded-lg !bg-cyan-500 !font-semibold !text-white"
                  sx={{
                    height: 50,
                    display: "flex",
                    alignItems: "center",
          ...
          <Box className="flex w-full gap-4">
            ...
            <Box className="flex w-3/5 flex-col gap-3">
              {/* ------------------------------------------- Summary Section -----------------------------------------*/}
              <SummarySection />
              {/* ------------------------------------------ Bar Chart Section ----------------------------------------*/}
            ...
            <Box className="flex w-2/5 flex-col gap-3">
              {/* --------------------------------------- Data Section ------------------------------------------------*/}
              <TotalData />

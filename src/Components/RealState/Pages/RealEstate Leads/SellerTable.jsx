...
const handleMenuClick = (option) => {
 ...
 handleMenuClose();
  ...
  const columns = [
    ...
    { field: "propertyType", headerName: "Property Type", minWidth: 150, flex: 1 },
    { field: "askingPrice", headerName: "Asking Price", minWidth: 150, flex: 1 },
    {
        field: "action",
        headerName: "Action",
        minWidth: 80,
  ...
  ].filter((col) => col.field === "action" || selectedColumns.includes(col.field));
    //---------------------------- Modal Close Button------------------------------------------------
  ...
  return (
    ...
    <Paper sx={{ width: "100%", overflow: "hidden" }}>
      ...
      >
        <MenuItem onClick={() => handleMenuClick("Preview")}>Preview</MenuItem>
        <MenuItem onClick={() => handleMenuClick("Details")}>Details</MenuItem>
        <MenuItem onClick={() => handleMenuClick("Print")}>Print</MenuItem>
        <MenuItem onClick={() => handleMenuClick("Seller Listing")}>Seller Listing</MenuItem>
      </Menu>
    </Paper>
     {/* ---------------------------- Preview Modal -------------------------- */}

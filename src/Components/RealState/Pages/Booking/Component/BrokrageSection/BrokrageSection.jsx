  ...
  return (
    <div className="flex h-full flex-col gap-8 bg-gray-200">
      ...
      <Box className="flex flex-wrap justify-end gap-5">
        {/* Columns Button */}
        {/* New Invoice Button */}
        <button onClick={()=>{ setOpen(true);}} className="flex w-full items-center justify-center gap-2 rounded-md bg-cyan-500 px-4 py-2 text-white shadow-md hover:bg-cyan-600 md:w-auto">
